        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="col-span-1 md:col-span-1">
            <Link to="/" className="flex items-center gap-2 mb-6">
              <img src="https://i.imgur.com/feZnmkl.jpeg" alt="Liquid Rubber Tech" className="h-10 w-auto object-contain rounded-full" />
            </Link>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-start gap-3">
                ...
                <a href="mailto:info@liquidrubbertech.com" className="text-gray-400 hover:text-white text-sm">info@liquidrubbertech.com</a>
              </li>
            </ul>
          </div>
